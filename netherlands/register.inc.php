...
$registered = false;
$codestsv = '';
$codes = file("online/$cca/$cur_year/codes.tsv");
$realteams = array();
$art = file("online/$cca/$cur_year/realteams");
...
else if (isset($_POST['reg']) && !$err)
{
  ...
  file_put_contents("online/$cca/$cur_year/codes.tsv", $codestsv);
  file_put_contents('online/'.$cca.'/passwd/'.$_POST['team'], md5(trim($_SESSION['Session_password'])).':player');
