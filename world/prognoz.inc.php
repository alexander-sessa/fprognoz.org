...
'игрок гостей нащупал изьян между ног у соперника и ловко им воспользовался.',
       ],
  0 => [
...
'игрок хозяев нащупал изьян между ног у соперника и ловко им воспользовался.',
       ],
  2 => [
...
if (isset($matches))       // REST responce on event 'matches'
  ...
  echo '[{"id":"#dynamic","html":"' . rawurlencode('
	...
	<div id="pl" class="" tabindex="-1" style="width:576px;min-width:576px;>' . $prognozlist . '</div>
') . '"}]';
else
{
  $html = $closed ? '' : '
