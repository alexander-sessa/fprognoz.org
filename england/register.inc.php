...
else if (sizeof($codes) >= 45)
  echo 'Регистрация в '.$title.' остановлена в связи с достаточной укомплектованностью лиг. Оставшиеся 3 места будут разыграны в Предсезонном конкурсе.';
else if (isset($_POST['reg']) && !$err)
{
  ...
  else if (isset($_SESSION['Coach_mail']))
    $email = $_SESSION['Coach_mail'];
  else
...
Вы можете входить на сайт по своему имени, EMail или коду команды с указанным Вами паролем.<br>
';
  if (isset($_POST['pass1']))
...
<br />
Укажите своё настоящее или игровое имя:<br>
