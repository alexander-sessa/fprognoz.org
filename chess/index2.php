...
function showGame($game, $n=0) {
    $html = '
        <div class="row">
            ...
            <h4>'.$game['event'].' '.$game['site'].' '.$game['date'].' '.$game['result'].'</h4>
        </div>
        <div class="row">
            <div class="col-5">
                <div id="board-'.$n.'" style="width: 400px"></div>
                <button id="start-'.$n.'" class="start">&laquo;</button>
                <button id="prev-'.$n.'" class="prev">&lt;</button>
                <button id="next-'.$n.'" class="next">&gt;</button>
                <button id="final-'.$n.'" class="final">&raquo;</button>
            </div>
            <div class="col-7">
            </div>';
