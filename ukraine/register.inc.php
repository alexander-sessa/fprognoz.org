...
if ($registered)
  ...
  echo 'Регистрация в '.$title.' остановлена в связи с полной укомплектованностью лиг.<br>
Если Вы хотите играть, напишите нам в разделе <a href="?m=vacancy">Вакансии</a> - мы найдём для Вас место.';
